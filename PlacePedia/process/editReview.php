...
if ($_SESSION['status'] == 'true'){
    ...
    if ($result->num_rows > 0) {
        ...
        if ($conn->query($sqlA) === TRUE) {
            header("location: ../place.php?id=" . $_POST['location'] . "&reviewSuccess=Uw review is aangepast!");
        }
    } else {
        header("location: ../place.php?id=" . $_POST['location'] . "&reviewError=Er ging iets mis met het aanpassen van uw review. Probeer het opnieuw!");
    }
    /*
